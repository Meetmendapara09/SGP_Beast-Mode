...
export class MainScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.physics.add.overlap(this.player, toFocusZonePortal, () => { this.player.setPosition(430, 400); });
    ...
    this.physics.add.overlap(this.player, toCoffeeRoomPortal, () => { this.player.setPosition(375, 680); });
    ...
    this.physics.add.overlap(this.player, toLoungeFromCoffeePortal, () => { this.player.setPosition(200, 580); });
    ...
    this.physics.add.overlap(this.player, toLoungeFromAdminPortal, () => { this.player.setPosition(225, 320); });
    ...
    this.physics.add.overlap(this.player, toAdminLoungePortal, () => {
        if (this.myRole === 'Admin') this.player.setPosition(225, 430);
